...
- ☁️ **Google Drive sync** — Optional and off by default. Back up your data to your own Drive, and export transactions to a new Google Sheet, any time.
...
2. Go to **APIs & Services → Library** and enable the **Google Drive API** and **Google Sheets API**.
3. Go to **APIs & Services → OAuth consent screen** — choose "External," fill in the basic required fields, and add your own Google account as a test user (or publish the app if you want others to use it).
